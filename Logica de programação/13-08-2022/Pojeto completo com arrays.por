...
Programa multiusuário usar os conceitos de vetor e matriz para ter mais de uma conta cadastrada.*/
	...
	real saldo, limite, total, saque, deposito, diferenca , contador=0.0
	real operacao_credito[10], operacao_debito[10]
	caracter voltar
	inteiro posicaoDoUsuarioNaMatriz
	...
	funcao verifica_saldo() {
		saldo = valoresDisponiveisPorUsuario[posicaoDoUsuarioNaMatriz][0]
		limite = valoresDisponiveisPorUsuario[posicaoDoUsuarioNaMatriz][1]
		total = saldo + limite
